  ...
  private void handleTypedArray(Context context, AttributeSet attrs)
  {
    ...
    try
    {
      mIndicatorBackground = typedArray.getResourceId(
          R.styleable.CircleIndicator_ci_background, DEFAULT_INDICATOR_BACKGROUND);
    }
    catch (Exception e)
    {
    }

    mIndicatorSelectedBackground = typedArray.getResourceId(
        R.styleable.CircleIndicator_ci_selected_background, DEFAULT_INDICATOR_SELECTED_BACKGROUND);
