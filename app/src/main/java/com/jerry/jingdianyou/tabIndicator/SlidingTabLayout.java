package com.jerry.jingdianyou.tabIndicator;
/**
 ...
 * You may obtain sliding_layout copy of the License at
 *
...
/**
 * To be used with ViewPager to provide sliding_layout tab indicator component which give
...
public class SlidingTabLayout extends HorizontalScrollView
{
   ...
   * are treated as sliding_layout circular array. Providing one color will mean that all
  ...
  /**
   * Create sliding_layout default view to be used for tabs. This is called if sliding_layout custom tab
  ...
  private void populateTabStrip()
  {
    ...
    for (int i = 0; i < adapter.getCount(); i++)
    {
      ...
      {
        // If there is sliding_layout custom tab view layout id set, try and inflate it
