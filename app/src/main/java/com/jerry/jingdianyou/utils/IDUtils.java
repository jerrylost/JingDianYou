...
public class IDUtils
{
    ...
    public boolean IDCardValidate(String IDStr) throws ParseException
    {
        ...
        if ((gc.get(Calendar.YEAR) - Integer.parseInt(
                strYear)) > 150 || (gc.getTime().getTime() - s.parse(
        ...
        for (int i = 0;
             ...
             i++)
        {
            TotalmulAiWi = TotalmulAiWi + Integer.parseInt(
                    String.valueOf(Ai.charAt(i))) * Integer.parseInt(Wi[i]);
        }
